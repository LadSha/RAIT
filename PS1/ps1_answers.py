...
#  [1,0] - down
#  [-1,0] - up
#"based upon this code: https://gatech.instructure.com/courses/325394/pages/4-localization-program-answer?module_item_id=3202202
...
def sense(p, measurement,sensor_right,colors):
    s = 0.0
    aux = [[0.0 for _col in range(len(p[0]))] for _row in range(len(p))]
