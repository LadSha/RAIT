...
#"based upon this code: https://gatech.instructure.com/courses/325394/pages/6-final-quiz-answer?module_item_id=3202612
whoami = 'lshamaei3'
...
def q4_move(self, motion, tolerance = .001):
    res = robot()
